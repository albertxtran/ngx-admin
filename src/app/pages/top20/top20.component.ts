...
export class Top20Component implements OnInit, OnDestroy  {
  ...
  constructor(private route: ActivatedRoute,  private _top20Service: Top20Service, public _toasterService: ToasterService , vcr: ViewContainerRef, private dialogService:DialogService, private router: Router) {
  ...
  removeTop20(id:Number) {
    ...
    error => {
      this.unsetOverlay();
      this._toasterService.showError("Could not remove Top 20, please try again!", "Error", 4000)}, 
      () =>{
        let trigger = false;
...
/*       pdfMake.fonts = {
      ...
      var docDefinition = {
          ...
          content: [
            ...
            { text: 'Suggested Startups for '+this.corporation, style: 'header' },
            {
